...
namespace SystemInfoViewer
{
    public sealed partial class MainWindow : Window
    {
        ...
        private async Task ForceTitleBarUpdate(bool isDark)
        {
            try
            {
                ...
                ApplyTheme(isDark ? ElementTheme.Dark : ElementTheme.Light);
            }
            catch (Exception ex)
            {
        ...
        private void LoadSavedTheme()
        {
            try
            {
                ...
                _isDarkTheme = (savedTheme == nameof(ElementTheme.Dark));
